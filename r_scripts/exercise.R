...
# In 2018, a 36 pages long action plan called A More Active Scotland was published. It's aim is to find ways to encourage people to be more physically active.
# Also Transport Scotland produced The Active Travel Framework aiming to increase the levels of active travel (walking or cycling) in Scotland.
# (just to pick an example, it was suggesting to increase investment into making towns and cities safer for walkers and cyclist)
# These plans and frameworks have further impact to other action plans, for instance plans aiming to lower carbon emission etc.
...
# In 2018, 2/3 two thirds (65%) of adults aged 16 and over were overweight in Scotland, including 28% who were obese. The numbers are remaining broadly stable since 2008
